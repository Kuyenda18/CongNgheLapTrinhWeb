...
class BrandProduct extends Controller
{
    ...
    public function all_brand_product(){
        ...
        return view('admin_layout')->with('admin.all_brand_product',$manager_brand_product);//b18
    }
    ...
    public function edit_brand_product($brand_product_id){
        ...
        return view('admin_layout')->with('admin.edit_brand_product',$manager_brand_product);//b15
