            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="position-center">
                        <form role="form" action="{{URL::to('/save-product')}}" method="post" enctype="multipart/form-data" > {{-- xử lý thêm ảnh phải có multipart/form-data--}}
                            {{ csrf_field()}}
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="5" class="form-control" name="product_desc" id="exampleInputPassword1" placeholder="Mô tả sảng phẩm"></textarea>
                        </div>
                        <div class="form-group">
